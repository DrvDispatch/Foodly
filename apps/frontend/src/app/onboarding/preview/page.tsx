            ...
            <div className="card p-6 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="text-center p-3 rounded-xl bg-blue-50 dark:bg-blue-900/30">
                        ...
                        <p className="text-xs text-blue-700 dark:text-blue-300 mb-1">Protein</p>
                        {isEditing ? (
                            <input
                                type="number"
                            ...
                            <p className="text-xl font-semibold text-blue-900 dark:text-white">{targets.protein}g</p>
                        )}
                        <p className="text-xs text-blue-600 dark:text-blue-400">{macroPercentages.protein}%</p>
                    </div>
                    ...
                    <div className="text-center p-3 rounded-xl bg-amber-50 dark:bg-amber-900/30">
                        ...
                        <p className="text-xs text-amber-700 dark:text-amber-300 mb-1">Carbs</p>
                        {isEditing ? (
                            <input
                                type="number"
                            ...
                            <p className="text-xl font-semibold text-amber-900 dark:text-white">{targets.carbs}g</p>
                        )}
                        <p className="text-xs text-amber-600 dark:text-amber-400">{macroPercentages.carbs}%</p>
                    </div>

                    {/* Fat */}
                    <div className="text-center p-3 rounded-xl bg-pink-50 dark:bg-pink-900/30">
                        <Droplets className="w-5 h-5 text-pink-500 mx-auto mb-1" />
                        <p className="text-xs text-pink-700 dark:text-pink-300 mb-1">Fat</p>
                        {isEditing ? (
                            <input
                                type="number"
                            ...
                            <p className="text-xl font-semibold text-pink-900 dark:text-white">{targets.fat}g</p>
                        )}
                        <p className="text-xs text-pink-600 dark:text-pink-400">{macroPercentages.fat}%</p>
                    </div>
                </div>
