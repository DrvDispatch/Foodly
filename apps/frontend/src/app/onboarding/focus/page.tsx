...
const focusOptions: { id: SecondaryFocus; label: string; emoji: string }[] = [
    { id: 'strength_lifting', label: 'Athletic Performance', emoji: '⚡' },
    { id: 'endurance', label: 'Recovery & Sleep', emoji: '😴' },
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                ...
                                isSelected
                                    ? "border-primary-500 dark:border-primary-400 ring-2 ring-primary-400 ring-offset-2 ring-offset-surface-50 dark:ring-offset-surface-900 shadow-soft"
                                    : isDisabled
                                        ? "border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900 opacity-50 cursor-not-allowed"
